package edu.gandhi.prajit.moviecruiser.resources;
...
public class MovieController
{
	...
	@ApiResponses({ @ApiResponse(code = 201, message = "Movie Created"), @ApiResponse(code = 409, message = "Movie Already Exists In Database")
	})
	public ResponseEntity<?> createNewMovie(@ApiParam(value = "Movie Request", required = true) @RequestBody final Movie movie)
	{
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Movie Information Updated"), @ApiResponse(code = 409, message = "Movie Not Exists In Database")
	})
	public ResponseEntity<?> updateMovieInformation(@ApiParam(value = "Movie Id For Update", required = true) @PathVariable final Integer id, @ApiParam(value = "Movie Request", required = true) @RequestBody final Movie movie)
	{
		try
		{
	...
	public ResponseEntity<String> deleteMovieByMovieId(@ApiParam(value = "Movie Id For Delete", required = true) @PathVariable final Integer id)
	{
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Movie Information Retrieved"), @ApiResponse(code = 404, message = "Movie Not Exists In Database")
	})
	public ResponseEntity<?> getMovieByMovieId(@ApiParam(value = "Movie Id For Retrieval", required = true) @PathVariable final Integer id)
	{
